...
// Fragment shader - hover trail with ASCII scramble and displacement effect
const fragmentShader = `
  ...
  void main() {
    ...
    // Apply UV displacement - warp effect (stronger than ripple for trail)
...
export class HoverTrailDisplaceEffect {
