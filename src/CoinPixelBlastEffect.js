...
// PixelBlast shader - fragment shader
...
// Coin vertex shader with lighting
...
// Coin fragment shader - lighting-based dithering like CoinDitheringEffect
...
export class CoinPixelBlastEffect {
  constructor(container, svgPath, width, height) {
  ...
  init() {
    ...
    // Create camera with orthographic projection like CoinDitheringEffect
    ...
    // Create background plane with PixelBlast shader
    this.createPixelBlastBackground()
    
    // Load and create coin
    this.loadCoin()
